...
$doc->addScript('//api-maps.yandex.ru/2.1/?lang=ru_RU')
    ...
    ->addScript($basePath . 'assets/js/places_point_adm.js')
...
if (!$editoroptions)
{
  ...
  $params->show_point_options = '1';
  $params->show_urls_images_backend = '0';
  $params->show_urls_images_frontend = '0';
}

// Check if the point uses configuration settings besides global. If so, use them.
if (isset($this->item->attribs['show_publishing_options']) && $this->item->attribs['show_publishing_options'] != '')
{
  $params->show_publishing_options = $this->item->attribs['show_publishing_options'];
}

if (isset($this->item->attribs['show_point_options']) && $this->item->attribs['show_point_options'] != '')
{
  $params->show_point_options = $this->item->attribs['show_point_options'];
}
...
?>
<form action="<?php echo JRoute::_('index.php?option=com_places&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">

  <div class="form-inline form-inline-header"> 
    <div class="control-group">
      <?php echo $this->form->getField('townid')->getControlGroup(); ?>
    </div>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <div class="input-append">
          ...
          <button id="addressSearchBtn" class="btn" type="button">
  ...
  <div class="form-horizontal">
    ...
    <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_PLACES_POINT_INFO', true)); ?>
    <div class="row-fluid">
      <div class="span5">
        <div class="control-group">
          <div class="control-label">
        ...
        <?php echo $this->form->getField('title')->getControlGroup(); ?>
        <?php echo $this->form->getField('type')->getControlGroup(); ?>
        <?php echo $this->form->getField('phone')->getControlGroup(); ?>
        <?php echo $this->form->getField('org_fax')->getControlGroup(); ?>
        <?php echo $this->form->getField('email')->getControlGroup(); ?>
        <?php echo $this->form->getField('site')->getControlGroup(); ?>
    ...
    <div class="row-fluid">
      <div class="span12">
        <?php echo $this->form->getField('desc')->getControlGroup(); ?>
      </div>
    </div>
    <?php echo JHtml::_('bootstrap.endTab'); ?>
    
    <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'UR', JText::_('COM_PLACES_FIELDSET_UR_ACCOUNT', true)); ?>
    <div class="row-fluid">
      <div class="span6">
        <?php echo $this->form->getField('org_yr_addr')->getControlGroup(); ?>
        <?php echo $this->form->getField('org_inn')->getControlGroup(); ?>
        <?php echo $this->form->getField('org_kpp')->getControlGroup(); ?>
        <?php echo $this->form->getField('org_ogrn')->getControlGroup(); ?>
      </div>
      <div class="span6">
        <?php echo $this->form->getField('pay_bank_name')->getControlGroup(); ?>
        <?php echo $this->form->getField('pay_bank_address')->getControlGroup(); ?>
        <?php echo $this->form->getField('pay_corr_bill')->getControlGroup(); ?>
        <?php echo $this->form->getField('pay_bill')->getControlGroup(); ?>
        <?php echo $this->form->getField('pay_bik')->getControlGroup(); ?>
      </div>
    </div>
    ...
    <?php $this->show_options = $params->show_point_options; ?>
