 ...
 * @since       1.5
 */
class PlacesViewTown extends JViewLegacy
{
	protected $form;
	...
	public function display($tpl = null)
	{
		...
		$this->canDo	= JHelperContent::getActions('com_places', 'town', $this->item->id);
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(
			JText::_('COM_PLACES_PAGE_' . ($checkedOut ? 'VIEW_TOWN' : ($isNew ? 'ADD_TOWN' : 'EDIT_TOWN'))),
			'flag-3'
		);
